...
<head>
    ...
    <?php echo Html::style('css/w3.css'); ?>
  ...
  <script>
      window.time=999;
            ...
            $.ajax({url: "<?php echo e(url('ques')); ?>",
                data:{
                package:'<?php echo e($package); ?>',
                set:'<?php echo e($set); ?>'
                },
                success: function(data) {
                    ...
                    $(function () {
                        $("#includedContent").load("<?php echo e(asset('template/script.tpl')); ?>");
                        $.getScript("<?php echo e(asset('js/main2.js')); ?>")
  ...
  <?php echo Html::script('js/underscore.js'); ?>
    ...
    <?php echo Html::script('js/questions.js'); ?>

  <?php echo Html::script('js/status.js'); ?>
    ...
    <div class="main col-md-12">
        ...
        <div class="col-md-12">
         ...
         <div class="col-md-2">
             ...
             <?php echo HTML::image('images/img_avatar.png', 'alt profile_pic', array('class' => 'profileimg')); ?>
        ...
        <div class="main-container col-md-12">
            ...
            <div class="col-md-2"><!--<img src="shot2.png" alt="instruction" style="width:30vh;height:12vh"/>-->
              <?php echo HTML::image('images/shot2.png', 'alt instructions', array('class' => 'instructionimg')); ?>
...
window.onbeforeunload = function() { return "Your work will be lost."; };
    ...
    <?php echo Form::open(array("id"=>"submitPaper",'url' => 'submitPaper', 'method' => 'POST') ); ?>
