...
<div id="app">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(url('/profile')); ?>"><i class="fa fa-btn fa-sign-out">Profile</i></a>
    ...
    <main>
        ...
        <div>
            <?php echo $__env->make('seeder.layouts.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
        <div>
